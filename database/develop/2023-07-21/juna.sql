...
(1, 1, 2, 1941720069, 'Adi Samara', '2023-07-21 18:01:00', '2023-07-21 18:13:31');
...
(2, 'Latihan Semester 1 Kelas TI-1A', '2023-07-21 21:20:08', '0000-00-00 00:00:00');
...
(1, 2, 2, '2023-07-21 21:20:08', NULL),
(2, 2, 3, '2023-07-21 21:20:08', NULL),
(3, 2, 4, '2023-07-21 21:20:08', NULL),
(4, 2, 5, '2023-07-21 21:20:08', NULL);
...
--
-- Table structure for table `simulasi_paket`
--

CREATE TABLE `simulasi_paket` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `simulasi_id` bigint(20) UNSIGNED NOT NULL,
  `paket_id` bigint(20) UNSIGNED NOT NULL,
  `created_at` datetime DEFAULT NULL,
...
(2, 'mahasiswa', '', '1941720069', '$2y$10$DysRmHmPnmGMcD8wk.a5A.jM/MAY.dRI19/fje1.Dge00DF1/1GcK', '2023-07-21 11:01:00', '2023-07-21 11:13:31');
...
--
-- Indexes for table `simulasi_paket`
--
ALTER TABLE `simulasi_paket`
  ADD PRIMARY KEY (`id`),
  ADD KEY `soal_paket` (`paket_id`),
  ADD KEY `soal_soal` (`simulasi_id`);
...
--
-- AUTO_INCREMENT for table `simulasi_paket`
--
ALTER TABLE `simulasi_paket`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `simulasi_paket`
--
ALTER TABLE `simulasi_paket`
  ADD CONSTRAINT `soal_paket` FOREIGN KEY (`paket_id`) REFERENCES `paket` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `soal_soal` FOREIGN KEY (`simulasi_id`) REFERENCES `simulasi` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
