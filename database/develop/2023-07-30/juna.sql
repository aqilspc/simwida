...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Jul 30, 2023 at 05:35 AM
...
INSERT INTO `simulasi` (`id`, `autograding`, `type`, `kelas_id`, `paket_id`, `nama`, `deskripsi`, `start_date_time`, `end_date_time`, `created_at`, `updated_at`) VALUES
(2, 'tidak', 'latihan', 2, 2, 'Latihan Semester 1 Kelas TI-1B', 'Simulasi adalah suatu proses peniruan dari sesuatu yang nyata beserta keadaan sekelilingnya (state of affairs). Aksi melakukan simulasi ini secara umum menggambarkan sifat-sifat karakteristik kunci dari kelakuan sistem fisik atau sistem.', '2023-07-28 20:21:00', '2023-07-30 20:21:00', '2023-07-28 20:21:12', '2023-07-30 06:32:18'),
(3, 'iya', 'ujian', 2, 2, 'Ujian Semester 1', 'Simulasi adalah suatu proses peniruan dari sesuatu yang nyata beserta keadaan sekelilingnya (state of affairs). Aksi melakukan simulasi ini secara umum menggambarkan sifat-sifat karakteristik kunci dari kelakuan sistem fisik atau sistem.', '2023-07-28 20:31:00', '2023-07-30 20:31:00', '2023-07-28 20:33:30', '2023-07-30 09:11:54');
...
(1, 'latihan', 2, 1, '30', 1, '2023-07-30 08:24:50', NULL),
(4, 'latihan', 2, 1, '10', 2, '2023-07-30 08:48:40', NULL),
(6, 'latihan', 2, 1, '10', 3, '2023-07-30 10:03:18', NULL);
...
(3, 'latihan', 2, 2, 2, 1, '830556785_2_latihan_2_1_log.sql', 'right', 'SELECT * FROM produk WHERE kategori = \'pupuk\';', 1, '2023-07-30 07:40:45', '2023-07-30 07:40:45'),
(4, 'latihan', 2, 3, 2, 1, '938497255_2_latihan_3_1_log.sql', 'not', 'SELECT * FROM produk WHERE kategori = \'pupuk\';', 1, '2023-07-30 07:41:48', '2023-07-30 07:41:48'),
(5, 'latihan', 2, 4, 2, 1, '1054490205_2_latihan_4_1_log.sql', 'right', 'SELECT * FROM produk WHERE kode NOT IN (\'PPK001\');', 1, '2023-07-30 07:53:30', '2023-07-30 07:53:30'),
(6, 'latihan', 2, 5, 2, 1, '2109964278_2_latihan_5_1_log.sql', 'right', 'SELECT * FROM produk GROUP BY kemasan;', 1, '2023-07-30 08:23:43', '2023-07-30 08:23:43'),
(7, 'latihan', 2, 2, 2, 1, '1120308177_2_latihan_2_1_log.sql', 'not', 'SELECT * FROM produk GROUP BY kemasan;', 2, '2023-07-30 08:48:08', '2023-07-30 08:48:08'),
(8, 'latihan', 2, 3, 2, 1, '1268144180_2_latihan_3_1_log.sql', 'not', 'SELECT * FROM produk GROUP BY kemasan;', 2, '2023-07-30 08:48:28', '2023-07-30 08:48:28'),
(9, 'latihan', 2, 4, 2, 1, '1292512752_2_latihan_4_1_log.sql', 'not', 'SELECT * FROM produk GROUP BY kemasan;', 2, '2023-07-30 08:48:34', '2023-07-30 08:48:34'),
(10, 'latihan', 2, 5, 2, 1, '1132193280_2_latihan_5_1_log.sql', 'right', 'SELECT * FROM produk GROUP BY kemasan;', 2, '2023-07-30 08:48:40', '2023-07-30 08:48:40'),
(11, 'latihan', 2, 2, 2, 1, '1994038465_2_latihan_2_1_log.sql', 'right', 'SELECT * FROM produk WHERE kategori = \'pupuk\';', 3, '2023-07-30 10:01:15', '2023-07-30 10:01:15'),
(12, 'latihan', 2, 3, 2, 1, '490808056_2_latihan_3_1_log.sql', 'not', 'SELECT * FROM produk WHERE kategori = \'pupuk\';', 3, '2023-07-30 10:02:13', '2023-07-30 10:02:13'),
(13, 'latihan', 2, 4, 2, 1, '2019564484_2_latihan_4_1_log.sql', 'not', 'SELECT * FROM produk WHERE kategori = \'pupuk\';', 3, '2023-07-30 10:02:19', '2023-07-30 10:02:19'),
(14, 'latihan', 2, 5, 2, 1, '1219323491_2_latihan_5_1_log.sql', 'not', 'SELECT * FROM produk WHERE kategori = \'pupuk\';', 3, '2023-07-30 10:02:26', '2023-07-30 10:02:26'),
(15, 'latihan', 2, 2, 2, 1, '1687826724_2_latihan_2_1_log.sql', 'not', 'SQLSTATE[42000]: Syntax error or access violation: 1064 You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near \'FRO produk WHERE kategori = \'pupuk\'\' at line 1 (Connection: mysql, SQL: SELECT * FRO produk WHERE kategori = \'pupuk\';)', 4, '2023-07-30 10:17:52', '2023-07-30 10:17:52'),
(16, 'latihan', 2, 3, 2, 1, '51679980_2_latihan_3_1_log.sql', 'not', 'SQLSTATE[42000]: Syntax error or access violation: 1064 You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near \'FRO produk WHERE kategori = \'pupuk\'\' at line 1 (Connection: mysql, SQL: SELECT * FRO produk WHERE kategori = \'pupuk\';)', 4, '2023-07-30 10:21:32', '2023-07-30 10:21:32');
...
(4, 1, 2, 'latihan', '2023-07-30 06:32:18', '2023-07-30 06:32:18'),
(5, 1, 3, 'ujian', '2023-07-30 09:11:54', '2023-07-30 09:11:54');
