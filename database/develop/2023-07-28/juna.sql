...
(2, 'tidak', 'latihan', 2, 2, 'Latihan Semester 1 Kelas TI-1B', 'Simulasi adalah suatu proses peniruan dari sesuatu yang nyata beserta keadaan sekelilingnya (state of affairs). Aksi melakukan simulasi ini secara umum menggambarkan sifat-sifat karakteristik kunci dari kelakuan sistem fisik atau sistem.', '2023-07-28 20:21:00', '2023-07-29 20:21:00', '2023-07-28 20:21:12', '2023-07-28 20:25:08'),
(3, 'iya', 'ujian', 2, 2, 'Ujian Semester 1', 'Simulasi adalah suatu proses peniruan dari sesuatu yang nyata beserta keadaan sekelilingnya (state of affairs). Aksi melakukan simulasi ini secara umum menggambarkan sifat-sifat karakteristik kunci dari kelakuan sistem fisik atau sistem.', '2023-07-28 20:31:00', '2023-07-29 20:31:00', '2023-07-28 20:33:30', NULL);
...
(2, 1, 2, 'latihan', '2023-07-28 20:25:08', '2023-07-28 20:25:08'),
(3, 1, 3, 'ujian', '2023-07-28 20:33:30', '2023-07-28 20:33:30');
...
(2, 'Tulisakan query untuk menapatkan produk dengan kategori pupuk', 'SELECT * FROM produk WHERE kategori = \'pupuk\';', 1, '10', 'Selamat jawban anda benar untuk terus meningkatkan pemahaman anda terus belajar ya', 'Jawaban anda masih salah, harap perhatkan syntax yang anda upload dan periksa, serta korelasikan dengan petunjuk di soal', '2023-07-21 18:58:15', NULL),
